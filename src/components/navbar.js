...
const toogleNav = ()=>{
    ...
    return(
      <nav className=" fixed z-50   top-0   py-3 bg-amber-700 rounded-lg w-3/4 border-b border-neutral-700/80">
            <div className="container px-4 mx-auto relative text-sm ">
                <div className=" flex  justify-between items-center ">
                    <div className=" flex items-center flex-shrink-0">
                      <h1 className="text-center text-zinc-200 font-bigfont text-xl lg:text-3xl">Ecast Portifolio</h1>
